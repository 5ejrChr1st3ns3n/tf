...
namespace HexFileProcessor
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            await FetchHexNumberInformationAsync(filePath);
        }

        public static async Task FetchHexNumberInformationAsync(string filePath)
        {
            ...
            try
            {
                ...
                {
                    var hexNumbers = File.ReadAllLines(filePath);
