           ...
           if response.is_a?(Net::HTTPSuccess)
             ...
             if response_data && response_data['versions']
               ...
               if max_version
                ...
                level_author_name = metadata['levelAuthorName'] if metadata && metadata['levelAuthorName']
            
                # Assuming hex_number contains the hex code you want to insert
                db.execute("INSERT INTO your_table (key, age, mapper) VALUES (hex_number, created_at, level_author_name)")
               end
             end
           end
         end
